...
xcrun simctl create "iPhone 8+ (12.4)"             "$iPhone-8-Plus"                          "$iOS-12-4"

xcrun simctl create "iPhone SE (12.4)"             "$iPhone-SE"                              "$iOS-12-4"
xcrun simctl create "iPhone X (12.4)"              "$iPhone-X"                               "$iOS-12-4"
xcrun simctl create "iPhone Xs (12.4)"             "$iPhone-XS"                              "$iOS-12-4"
xcrun simctl create "iPhone Xs Max (12.4)"         "$iPhone-XS-Max"                          "$iOS-12-4"
xcrun simctl create "iPhone Xʀ (12.4)"             "$iPhone-XR"                              "$iOS-12-4"
xcrun simctl create "iPhone 11 (13.3)"             "$iPhone-11"                              "$iOS-13-3"
xcrun simctl create "iPhone 11 Pro (13.3)"         "$iPhone-11-Pro"                          "$iOS-13-3"
...
xcrun simctl create "iPad Pro (12.9-inch) (13.3)"  "$iPad-Pro--12-9-inch---3rd-generation-"  "$iOS-13-3"
