...
xcrun simctl create "iPhone 8 (12.1)"              "$iPhone-8"                               "$iOS-12-1"
xcrun simctl create "iPhone 8+ (12.1)"             "$iPhone-8-Plus"                          "$iOS-12-1"

xcrun simctl create "iPhone SE (12.1)"             "$iPhone-SE"                              "$iOS-12-1"
xcrun simctl create "iPhone X (12.1)"              "$iPhone-X"                               "$iOS-12-1"
xcrun simctl create "iPhone Xs (12.1)"             "$iPhone-XS"                              "$iOS-12-1"
xcrun simctl create "iPhone Xs Max (12.1)"         "$iPhone-XS-Max"                          "$iOS-12-1"
xcrun simctl create "iPhone Xʀ (12.1)"             "$iPhone-XR"                              "$iOS-12-1"
...
xcrun simctl create "iPad Pro (12.9-inch) (12.1)"  "$iPad-Pro--12-9-inch---3rd-generation-"  "$iOS-12-1"
